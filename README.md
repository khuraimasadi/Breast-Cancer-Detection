...
This is most useful app which is used to predict cancer cell. The app detect that the cell is either Benign(not cancer) or Malignant (cancer cell). This machine learning model is builded using support vector classifier and trained on large dataset. 
# Hi, I'm Abdullah! 👋
